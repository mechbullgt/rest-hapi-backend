...
const config = {
  $meta: 'This file configures the our APIs.',
  constants: constants,
...
// new Confidence.Store(document) is a configuration storage container
const store = new Confidence.Store(config)

/*retrieves a value from the configuration documet after applying the provided 
key : requested key path, all keys must begin with '/', '/' returns the whole document
criteria :(optional object used a criteria for applying filters in the configuration document, defaults {})
*/
...
/*
Returns the metadata found after applying the criteria. 
If the key is invalid or not found, or if no metadata is available, returns undefined.
*/
